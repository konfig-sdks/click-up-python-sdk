...
class Priority1(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["priority", "color", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["priority", "color", ], str]):
