...
class Guest1(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def shared() -> typing.Type['Shared1']:
                return Shared1
            __annotations__ = {
                "user": user,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["shared"]) -> 'Shared1': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["shared"]) -> 'Shared1': ...
