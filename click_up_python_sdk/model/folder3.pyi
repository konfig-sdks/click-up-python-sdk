...
class Folder3(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "hidden", "access", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "hidden", "access", ], str]):
