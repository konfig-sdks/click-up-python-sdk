...
class UpdateTaskresponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def tags() -> typing.Type['UpdateTaskresponseTags']:
                return UpdateTaskresponseTags
            ...
            @staticmethod
            def assignees() -> typing.Type['UpdateTaskresponseAssignees']:
                return UpdateTaskresponseAssignees
        
            @staticmethod
            def checklists() -> typing.Type['UpdateTaskresponseChecklists']:
                return UpdateTaskresponseChecklists
            ...
            class custom_fields(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CustomFields7']:
                        return CustomFields7
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CustomFields7'], typing.List['CustomFields7']],
                ...
                def __getitem__(self, i: int) -> 'CustomFields7':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tags"]) -> 'UpdateTaskresponseTags': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["assignees"]) -> 'UpdateTaskresponseAssignees': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["checklists"]) -> 'UpdateTaskresponseChecklists': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tags", "description", "id", "custom_id", "custom_item_id", "name", "text_content", "status", "archived", "orderindex", "date_created", "date_updated", "date_closed", "creator", "assignees", "checklists", "parent", "priority", "due_date", "start_date", "time_estimate", "time_spent", "custom_fields", "list", "folder", "space", "url", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tags"]) -> typing.Union['UpdateTaskresponseTags', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["assignees"]) -> typing.Union['UpdateTaskresponseAssignees', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["checklists"]) -> typing.Union['UpdateTaskresponseChecklists', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        tags: typing.Union['UpdateTaskresponseTags', schemas.Unset] = schemas.unset,
        ...
        assignees: typing.Union['UpdateTaskresponseAssignees', schemas.Unset] = schemas.unset,
        checklists: typing.Union['UpdateTaskresponseChecklists', schemas.Unset] = schemas.unset,
