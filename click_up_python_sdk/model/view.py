...
class View(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["parent"]) -> 'Parent': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "type", "parent", "grouping", "divide", "sorting", "filters", "columns", "team_sidebar", "settings", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["parent"]) -> 'Parent': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "type", "parent", "grouping", "divide", "sorting", "filters", "columns", "team_sidebar", "settings", ], str]):
