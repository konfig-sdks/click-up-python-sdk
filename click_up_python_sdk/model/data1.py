...
class Data1(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "creator", "tag_bg", "tag_fg", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "creator", "tag_bg", "tag_fg", ], str]):
