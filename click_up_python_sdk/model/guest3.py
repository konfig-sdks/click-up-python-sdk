...
class Guest3(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def shared() -> typing.Type['Shared3']:
                return Shared3
            __annotations__ = {
                "user": user,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["shared"]) -> 'Shared3': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["shared"]) -> 'Shared3': ...
