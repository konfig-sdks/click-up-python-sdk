...
class Value1(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "username", "email", "color", "initials", "profilePicture", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "username", "email", "color", "initials", "profilePicture", ], str]):
