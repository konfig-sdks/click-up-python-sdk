...
class CreateFolderlessListrequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "content", "due_date", "due_date_time", "priority", "assignee", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "content", "due_date", "due_date_time", "priority", "assignee", "status", ], str]):
