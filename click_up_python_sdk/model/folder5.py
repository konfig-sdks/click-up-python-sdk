...
class Folder5(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def lists() -> typing.Type['Folder5Lists']:
                return Folder5Lists
            __annotations__ = {
                "id": id,
                "name": name,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lists"]) -> 'Folder5Lists': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lists"]) -> 'Folder5Lists': ...
