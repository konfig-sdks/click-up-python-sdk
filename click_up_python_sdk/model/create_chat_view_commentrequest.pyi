...
class CreateChatViewCommentrequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["comment_text", "notify_all", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["comment_text", "notify_all", ], str]):
