...
class InviteGuestToWorkspacerequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "can_edit_tags", "can_see_time_spent", "can_see_time_estimated", "can_create_views", "custom_role_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "can_edit_tags", "can_see_time_spent", "can_see_time_estimated", "can_create_views", "custom_role_id", ], str]):
