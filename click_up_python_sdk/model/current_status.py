...
class CurrentStatus(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "color", "total_time", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "color", "total_time", ], str]):
