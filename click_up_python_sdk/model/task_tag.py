...
class TaskTag(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "tag_fg", "tag_bg", "creator", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "tag_fg", "tag_bg", "creator", ], str]):
