...
class KeyResult1(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def task_ids() -> typing.Type['KeyResult1TaskIds']:
                return KeyResult1TaskIds
        
            @staticmethod
            def subcategory_ids() -> typing.Type['KeyResult1SubcategoryIds']:
                return KeyResult1SubcategoryIds
            ...
            @staticmethod
            def last_action() -> typing.Type['LastAction1']:
                return LastAction1
            __annotations__ = {
                "id": id,
                "goal_id": goal_id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["task_ids"]) -> 'KeyResult1TaskIds': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subcategory_ids"]) -> 'KeyResult1SubcategoryIds': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["owners"]) -> MetaOapg.properties.owners: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["last_action"]) -> 'LastAction1': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["task_ids"]) -> 'KeyResult1TaskIds': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subcategory_ids"]) -> 'KeyResult1SubcategoryIds': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["owners"]) -> MetaOapg.properties.owners: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["last_action"]) -> 'LastAction1': ...
