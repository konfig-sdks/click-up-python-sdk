...
class UpdateFolderresponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "orderindex", "override_statuses", "hidden", "space", "task_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "orderindex", "override_statuses", "hidden", "space", "task_count", ], str]):
