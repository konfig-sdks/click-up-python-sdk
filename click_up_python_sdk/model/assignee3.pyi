...
class Assignee3(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "color", "username", "initials", "profilePicture", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "color", "username", "initials", "profilePicture", ], str]):
