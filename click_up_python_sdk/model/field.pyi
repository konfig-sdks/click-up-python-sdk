...
class Field(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def type_config() -> typing.Type['TypeConfig']:
                return TypeConfig
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["type_config"]) -> 'TypeConfig': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "type", "type_config", "date_created", "hide_from_guests", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["type_config"]) -> 'TypeConfig': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "type", "type_config", "date_created", "hide_from_guests", ], str]):
