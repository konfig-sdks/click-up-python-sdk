...
class Team3(
        ...
        class properties:
            ...
            class members(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Members5']:
                        return Members5
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Members5'], typing.List['Members5']],
                ...
                def __getitem__(self, i: int) -> 'Members5':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "color", "avatar", "members", "roles", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "color", "avatar", "members", "roles", ], str]):
