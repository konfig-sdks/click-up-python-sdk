...
class Priority(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "priority", "color", "orderindex", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "priority", "color", "orderindex", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        priority: typing.Union[MetaOapg.properties.priority, str, ],
