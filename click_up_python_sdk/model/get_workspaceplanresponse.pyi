...
class GetWorkspaceplanresponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["plan_name", "plan_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["plan_name", "plan_id", ], str]):
