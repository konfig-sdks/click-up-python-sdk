...
class User2(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "username", "initials", "email", "color", "profilePicture", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "username", "initials", "email", "color", "profilePicture", ], str]):
