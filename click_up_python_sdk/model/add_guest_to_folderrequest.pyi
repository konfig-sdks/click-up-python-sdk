...
class AddGuestToFolderrequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["permission_level", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["permission_level", ], str]):
