...
class BaseApi(api_client.Api):
    ...
    def _delete_task_comment_mapped_args(
        self,
    ...
    async def _adelete_task_comment_oapg(
        self,
...
class DeleteTaskCommentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_task_comment(
        self,
        comment_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_task_comment_mapped_args(
            comment_id=comment_id,
        )
        return await self._adelete_task_comment_oapg(
    ...
    def delete_task_comment(
        ...
        return self._delete_task_comment_oapg(
            path_params=args.path,
        )

class DeleteTaskComment(BaseApi):
    ...
    async def adelete_task_comment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_task_comment(
            comment_id=comment_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_task_comment(
        ...
        raw_response = self.raw.delete_task_comment(
            comment_id=comment_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
