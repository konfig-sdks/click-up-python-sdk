...
from click_up_python_sdk.model.get_spaceresponse import GetSpaceresponse as GetSpaceresponseSchema

from click_up_python_sdk.type.get_spaceresponse import GetSpaceresponse

from ...api_client import Dictionary
from click_up_python_sdk.pydantic.get_spaceresponse import GetSpaceresponse as GetSpaceresponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetSpaceresponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetSpaceresponse
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetSpaceresponsePydantic:
        raw_response = await self.raw.aget_details(
            space_id=space_id,
            **kwargs,
        )
        if validate:
            return GetSpaceresponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetSpaceresponsePydantic, raw_response.body)
