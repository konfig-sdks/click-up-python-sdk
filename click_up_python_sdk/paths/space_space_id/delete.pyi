...
class RemoveSpaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_space(
        self,
        space_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_space_mapped_args(
            space_id=space_id,
        )
        return await self._aremove_space_oapg(
    ...
    def remove_space(
        ...
        return self._remove_space_oapg(
            path_params=args.path,
        )

class RemoveSpace(BaseApi):
    ...
    async def aremove_space(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_space(
            space_id=space_id,
            **kwargs,
        )
        if validate:
    ...
    def remove_space(
        ...
        raw_response = self.raw.remove_space(
            space_id=space_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
