...
# Query params
DependsOnSchema = schemas.StrSchema
DependencyOfSchema = schemas.StrSchema
CustomTaskIdsSchema = schemas.BoolSchema
TeamIdSchema = schemas.NumberSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'depends_on': typing.Union[DependsOnSchema, str, ],
        'dependency_of': typing.Union[DependencyOfSchema, str, ],
    }
)
...
request_query_depends_on = api_client.QueryParameter(
    name="depends_on",
    style=api_client.ParameterStyle.FORM,
    schema=DependsOnSchema,
    required=True,
    explode=True,
)
request_query_dependency_of = api_client.QueryParameter(
    name="dependency_of",
    style=api_client.ParameterStyle.FORM,
    schema=DependencyOfSchema,
    required=True,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _remove_dependency_mapped_args(
        self,
        task_id: str,
        depends_on: str,
        dependency_of: str,
        ...
        if depends_on is not None:
            _query_params["depends_on"] = depends_on
        if dependency_of is not None:
            _query_params["dependency_of"] = dependency_of
    ...
    async def _aremove_dependency_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_depends_on,
            request_query_dependency_of,
...
class RemoveDependencyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_dependency(
        self,
        task_id: str,
        depends_on: str,
        dependency_of: str,
        ...
        **kwargs,
        ...
        args = self._remove_dependency_mapped_args(
            task_id=task_id,
        ...
        return await self._aremove_dependency_oapg(
    ...
    def remove_dependency(
        ...
        return self._remove_dependency_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class RemoveDependency(BaseApi):
    ...
    async def aremove_dependency(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_dependency(
            task_id=task_id,
            depends_on=depends_on,
            dependency_of=dependency_of,
            custom_task_ids=custom_task_ids,
    ...
    def remove_dependency(
        ...
        raw_response = self.raw.remove_dependency(
            task_id=task_id,
            depends_on=depends_on,
            dependency_of=dependency_of,
            custom_task_ids=custom_task_ids,
