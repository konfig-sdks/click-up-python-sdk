...
from click_up_python_sdk.model.remove_guest_from_taskresponse import RemoveGuestFromTaskresponse as RemoveGuestFromTaskresponseSchema

from click_up_python_sdk.type.remove_guest_from_taskresponse import RemoveGuestFromTaskresponse

from ...api_client import Dictionary
from click_up_python_sdk.pydantic.remove_guest_from_taskresponse import RemoveGuestFromTaskresponse as RemoveGuestFromTaskresponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = RemoveGuestFromTaskresponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RemoveGuestFromTaskresponse
...
class BaseApi(api_client.Api):
    ...
    def _revoke_access_to_task_mapped_args(
        self,
        task_id: str,
    ...
    async def _arevoke_access_to_task_oapg(
        self,
    ...
    def _revoke_access_to_task_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RevokeAccessToTaskRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arevoke_access_to_task(
        self,
        task_id: str,
        guest_id: typing.Union[int, float],
        include_shared: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._revoke_access_to_task_mapped_args(
            task_id=task_id,
            guest_id=guest_id,
        ...
        return await self._arevoke_access_to_task_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def revoke_access_to_task(
        self,
        task_id: str,
        guest_id: typing.Union[int, float],
        include_shared: typing.Optional[bool] = None,
        ...
        return self._revoke_access_to_task_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class RevokeAccessToTask(BaseApi):
    ...
    async def arevoke_access_to_task(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RemoveGuestFromTaskresponsePydantic:
        raw_response = await self.raw.arevoke_access_to_task(
            task_id=task_id,
            guest_id=guest_id,
            include_shared=include_shared,
            custom_task_ids=custom_task_ids,
        ...
        if validate:
            return RemoveGuestFromTaskresponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RemoveGuestFromTaskresponsePydantic, raw_response.body)
    ...
    def revoke_access_to_task(
        ...
        raw_response = self.raw.revoke_access_to_task(
            task_id=task_id,
            guest_id=guest_id,
            include_shared=include_shared,
            custom_task_ids=custom_task_ids,
