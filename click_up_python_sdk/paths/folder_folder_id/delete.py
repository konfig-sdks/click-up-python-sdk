...
class BaseApi(api_client.Api):
    ...
    def _remove_folder_mapped_args(
        self,
    ...
    async def _aremove_folder_oapg(
        self,
...
class RemoveFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_folder(
        self,
        folder_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_folder_mapped_args(
            folder_id=folder_id,
        )
        return await self._aremove_folder_oapg(
    ...
    def remove_folder(
        ...
        return self._remove_folder_oapg(
            path_params=args.path,
        )

class RemoveFolder(BaseApi):
    ...
    async def aremove_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_folder(
            folder_id=folder_id,
            **kwargs,
        )
        if validate:
    ...
    def remove_folder(
        ...
        raw_response = self.raw.remove_folder(
            folder_id=folder_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
