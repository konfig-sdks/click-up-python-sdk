...
class RemoveListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_list(
        self,
        list_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_list_mapped_args(
            list_id=list_id,
        )
        return await self._aremove_list_oapg(
    ...
    def remove_list(
        ...
        return self._remove_list_oapg(
            path_params=args.path,
        )

class RemoveList(BaseApi):
    ...
    async def aremove_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_list(
            list_id=list_id,
            **kwargs,
        )
        if validate:
    ...
    def remove_list(
        ...
        raw_response = self.raw.remove_list(
            list_id=list_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
