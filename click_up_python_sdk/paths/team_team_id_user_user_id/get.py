...
from click_up_python_sdk.model.get_userresponse import GetUserresponse as GetUserresponseSchema

from click_up_python_sdk.type.get_userresponse import GetUserresponse

from ...api_client import Dictionary
from click_up_python_sdk.pydantic.get_userresponse import GetUserresponse as GetUserresponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetUserresponseSchema
...
class GetUserDetails(BaseApi):
    ...
    async def aget_user_details(
        ...
        **kwargs,
        ...
        if validate:
            return GetUserresponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetUserresponsePydantic, raw_response.body)
