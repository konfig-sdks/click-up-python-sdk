...
from click_up_python_sdk.model.get_goalresponse import GetGoalresponse as GetGoalresponseSchema

from click_up_python_sdk.type.get_goalresponse import GetGoalresponse

from ...api_client import Dictionary
from click_up_python_sdk.pydantic.get_goalresponse import GetGoalresponse as GetGoalresponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetGoalresponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetGoalresponse
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetGoalresponsePydantic:
        raw_response = await self.raw.aget_details(
            goal_id=goal_id,
            **kwargs,
        )
        if validate:
            return GetGoalresponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetGoalresponsePydantic, raw_response.body)
