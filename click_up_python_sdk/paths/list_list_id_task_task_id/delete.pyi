...
class BaseApi(api_client.Api):
    ...
    def _remove_task_from_list_mapped_args(
        self,
    ...
    async def _aremove_task_from_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/list/{list_id}/task/{task_id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _remove_task_from_list_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveTaskFromListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_task_from_list(
        self,
        list_id: typing.Union[int, float],
        task_id: str,
        **kwargs,
        ...
        args = self._remove_task_from_list_mapped_args(
            list_id=list_id,
            task_id=task_id,
        )
        return await self._aremove_task_from_list_oapg(
    ...
    def remove_task_from_list(
        ...
        return self._remove_task_from_list_oapg(
            path_params=args.path,
        )

class RemoveTaskFromList(BaseApi):
    ...
    async def aremove_task_from_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_task_from_list(
            list_id=list_id,
            task_id=task_id,
            **kwargs,
        )
    ...
    def remove_task_from_list(
        ...
        raw_response = self.raw.remove_task_from_list(
            list_id=list_id,
            task_id=task_id,
        )
        if validate:
