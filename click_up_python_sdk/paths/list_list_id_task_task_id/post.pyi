...
class BaseApi(api_client.Api):
    ...
    def _add_task_to_list_mapped_args(
        self,
    ...
    async def _aadd_task_to_list_oapg(
        self,
...
class AddTaskToListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_task_to_list(
        self,
        list_id: typing.Union[int, float],
        task_id: str,
        **kwargs,
        ...
        args = self._add_task_to_list_mapped_args(
            list_id=list_id,
            task_id=task_id,
        )
        return await self._aadd_task_to_list_oapg(
    ...
    def add_task_to_list(
        ...
        return self._add_task_to_list_oapg(
            path_params=args.path,
        )

class AddTaskToList(BaseApi):
    ...
    async def aadd_task_to_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_task_to_list(
            list_id=list_id,
            task_id=task_id,
            **kwargs,
        )
    ...
    def add_task_to_list(
        ...
        raw_response = self.raw.add_task_to_list(
            list_id=list_id,
            task_id=task_id,
        )
        if validate:
