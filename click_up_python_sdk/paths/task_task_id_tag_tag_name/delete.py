...
class BaseApi(api_client.Api):
    ...
    def _remove_from_task_mapped_args(
        self,
        task_id: str,
        tag_name: str,
    ...
    async def _aremove_from_task_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/task/{task_id}/tag/{tag_name}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class RemoveFromTaskRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_from_task(
        self,
        task_id: str,
        tag_name: str,
        custom_task_ids: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._remove_from_task_mapped_args(
            task_id=task_id,
            tag_name=tag_name,
            custom_task_ids=custom_task_ids,
            team_id=team_id,
        )
        return await self._aremove_from_task_oapg(
    ...
    def remove_from_task(
        ...
        return self._remove_from_task_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class RemoveFromTask(BaseApi):
    ...
    async def aremove_from_task(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_from_task(
            task_id=task_id,
            tag_name=tag_name,
            custom_task_ids=custom_task_ids,
            team_id=team_id,
    ...
    def remove_from_task(
        ...
        raw_response = self.raw.remove_from_task(
            task_id=task_id,
            tag_name=tag_name,
            custom_task_ids=custom_task_ids,
            team_id=team_id,
