...
from click_up_python_sdk.pydantic.custom_fields7 import CustomFields7
...
from click_up_python_sdk.pydantic.update_taskresponse_assignees import UpdateTaskresponseAssignees
from click_up_python_sdk.pydantic.update_taskresponse_checklists import UpdateTaskresponseChecklists
from click_up_python_sdk.pydantic.update_taskresponse_tags import UpdateTaskresponseTags

class UpdateTaskresponse(BaseModel):
    tags: typing.Optional[UpdateTaskresponseTags] = Field(None, alias='tags')
    ...
    assignees: typing.Optional[UpdateTaskresponseAssignees] = Field(None, alias='assignees')

    checklists: typing.Optional[UpdateTaskresponseChecklists] = Field(None, alias='checklists')
    ...
    custom_fields: typing.Optional[typing.List[CustomFields7]] = Field(None, alias='custom_fields')
