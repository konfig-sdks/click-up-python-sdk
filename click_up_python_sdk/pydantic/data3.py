...
from click_up_python_sdk.pydantic.data3_tags import Data3Tags
from click_up_python_sdk.pydantic.task6 import Task6
from click_up_python_sdk.pydantic.user2 import User2

class Data3(BaseModel):
    tags: Data3Tags = Field(alias='tags')

    description: str = Field(alias='description')

    id: str = Field(alias='id')

    task: Task6 = Field(alias='task')
