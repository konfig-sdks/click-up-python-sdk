...
from click_up_python_sdk.exceptions_base import ApiValueError
from click_up_python_sdk.exceptions import ClientConfigurationError
from click_up_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = click_up_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.clickup.com/api/v2" if host is None else host
        """Default Base url
        """
        ...
        if authorization_token:
            self.api_key['Authorization Token'] = authorization_token
        else:
            raise ClientConfigurationError('API Key "Authorization Token" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("click_up_python_sdk")
    ...
    def get_host_settings(self):
        ...
        return [
            ...
            {
                'url': "https://a00fb6e0-339c-4201-972f-503b9932d17a.remockly.com",
