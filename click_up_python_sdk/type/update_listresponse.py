...
class RequiredUpdateListresponse(TypedDict):
    id: str
...
class OptionalUpdateListresponse(TypedDict, total=False):
    pass

class UpdateListresponse(RequiredUpdateListresponse, OptionalUpdateListresponse):
    pass
