...
class RequiredCreateFolderlessListresponse(TypedDict):
    id: str
...
class OptionalCreateFolderlessListresponse(TypedDict, total=False):
    pass

class CreateFolderlessListresponse(RequiredCreateFolderlessListresponse, OptionalCreateFolderlessListresponse):
    pass
