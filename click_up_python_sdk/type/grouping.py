...
from click_up_python_sdk.type.grouping_collapsed import GroupingCollapsed

class RequiredGrouping(TypedDict):
...
class OptionalGrouping(TypedDict, total=False):
    pass

class Grouping(RequiredGrouping, OptionalGrouping):
    pass
